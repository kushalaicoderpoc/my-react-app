...
export default class CustomerDetails extends Component {
  ...
  render() {
    if (!this.state.customerDetails)
      return <p className="loading-text" style={{ color: 'white' }}>Loading Data</p>;
    return ( 
      <div className="customerdetails" style={{ backgroundColor: '#ffcccb', padding: '20px' }}>
        <Panel bsStyle="info" className="centeralign panel-background" style={{ backgroundColor: '#ffcccb', borderColor: '#b2e8b2' }}>
          ...
          <Panel.Body>
            ...
            <button className="toggle-button" onClick={this.toggleShowMore} style={{ transition: 'background-color 0.3s', backgroundColor: '#ffb3b3', color: 'white' }}>
