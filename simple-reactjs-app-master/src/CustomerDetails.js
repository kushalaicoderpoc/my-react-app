...
// This Component is a child of the Customers Component
export default class CustomerDetails extends Component {
  ...
  // Function called when the component loads for the first time
  componentDidMount() {
    this.getCustomerDetails(this.props.val);
  }

  // Function called whenever the component is updated
  ...
  // Function to load customer details data from JSON
