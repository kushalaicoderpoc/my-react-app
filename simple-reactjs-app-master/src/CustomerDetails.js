      ...
      <div className="customerdetails">
        <Panel bsStyle="info" className="centeralign">
          ...
          <Panel.Body>
            ...
            <div>
              <label>
                <input type="radio" value="option1" checked={this.state.radioValue === 'option1'} onChange={this.handleRadioChange} /> Option 1
              </label>
              <label>
                <input type="radio" value="option2" checked={this.state.radioValue === 'option2'} onChange={this.handleRadioChange} /> Option 2
              </label>
            </div>
          </Panel.Body>
        </Panel>
