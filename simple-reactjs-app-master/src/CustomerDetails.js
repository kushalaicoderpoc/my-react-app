    ...
    return (<div className="customerdetails">
      <Panel bsStyle="info" className="centeralign">
        ...
        <Panel.Body>
          ...
          {this.state.showAdditionalInfo && (<React.Fragment>
          ...
          <button onClick={this.toggleAdditionalInfo} aria-expanded={this.state.showAdditionalInfo} className="btn btn-link">
